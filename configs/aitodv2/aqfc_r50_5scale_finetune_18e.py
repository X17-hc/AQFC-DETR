"""
AQFC-DETR AI-TOD-V2 18 epoch 微调配置。
Mosaic 与 Copy-Paste 互斥，并使用 warmup/cosine decay。

使用方法：
  python main.py --config configs/aitodv2/aqfc_r50_5scale_finetune_18e.py \
      --data-root /path/to/AITODv2 --pretrained /path/to/model.pth \
      --output-dir outputs/aitodv2_finetune
"""
